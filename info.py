...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/thambithuthimaingrp')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/thambithuthichannel')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'thambithuthisupport') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/White_Blooded')
